...
public class TeoItemOptionalImpl extends ASTWrapperPsiElement implements TeoItemOptional {

  public TeoItemOptionalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitItemOptional(this);
  }
