...
public class TeoPaddedBlockCloseImpl extends ASTWrapperPsiElement implements TeoPaddedBlockClose {

  public TeoPaddedBlockCloseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitPaddedBlockClose(this);
  }
