...
public class TeoPaddedBlockOpenImpl extends ASTWrapperPsiElement implements TeoPaddedBlockOpen {

  public TeoPaddedBlockOpenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitPaddedBlockOpen(this);
  }
