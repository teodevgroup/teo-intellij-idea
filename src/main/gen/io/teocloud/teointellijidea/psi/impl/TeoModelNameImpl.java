...
public class TeoModelNameImpl extends ASTWrapperPsiElement implements TeoModelName {

  public TeoModelNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitModelName(this);
  }
