...
public class TeoPaddedBrackOpenImpl extends ASTWrapperPsiElement implements TeoPaddedBrackOpen {

  public TeoPaddedBrackOpenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitPaddedBrackOpen(this);
  }
