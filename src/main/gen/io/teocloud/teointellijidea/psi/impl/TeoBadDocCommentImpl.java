...
public class TeoBadDocCommentImpl extends ASTWrapperPsiElement implements TeoBadDocComment {

  public TeoBadDocCommentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitBadDocComment(this);
  }
