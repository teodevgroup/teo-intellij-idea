...
public class TeoConfigNameImpl extends ASTWrapperPsiElement implements TeoConfigName {

  public TeoConfigNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitConfigName(this);
  }
