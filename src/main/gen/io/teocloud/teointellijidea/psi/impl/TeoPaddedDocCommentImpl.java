...
public class TeoPaddedDocCommentImpl extends ASTWrapperPsiElement implements TeoPaddedDocComment {

  public TeoPaddedDocCommentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitPaddedDocComment(this);
  }
