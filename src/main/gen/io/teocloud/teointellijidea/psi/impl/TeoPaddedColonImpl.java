...
public class TeoPaddedColonImpl extends ASTWrapperPsiElement implements TeoPaddedColon {

  public TeoPaddedColonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitPaddedColon(this);
  }
