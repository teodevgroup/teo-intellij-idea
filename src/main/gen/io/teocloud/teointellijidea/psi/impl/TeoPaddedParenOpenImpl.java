...
public class TeoPaddedParenOpenImpl extends ASTWrapperPsiElement implements TeoPaddedParenOpen {

  public TeoPaddedParenOpenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitPaddedParenOpen(this);
  }
