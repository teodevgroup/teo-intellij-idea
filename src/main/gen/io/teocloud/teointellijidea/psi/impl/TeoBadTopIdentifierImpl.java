...
public class TeoBadTopIdentifierImpl extends ASTWrapperPsiElement implements TeoBadTopIdentifier {

  public TeoBadTopIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitBadTopIdentifier(this);
  }
