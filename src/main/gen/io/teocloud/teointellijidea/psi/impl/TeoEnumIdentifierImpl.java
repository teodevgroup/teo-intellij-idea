...
public class TeoEnumIdentifierImpl extends ASTWrapperPsiElement implements TeoEnumIdentifier {

  public TeoEnumIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitEnumIdentifier(this);
  }
