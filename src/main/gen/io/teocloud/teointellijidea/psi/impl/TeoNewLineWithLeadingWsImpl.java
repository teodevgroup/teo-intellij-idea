...
public class TeoNewLineWithLeadingWsImpl extends ASTWrapperPsiElement implements TeoNewLineWithLeadingWs {

  public TeoNewLineWithLeadingWsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitNewLineWithLeadingWs(this);
  }
