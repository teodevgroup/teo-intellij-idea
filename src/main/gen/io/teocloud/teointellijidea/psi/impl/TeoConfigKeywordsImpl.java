...
public class TeoConfigKeywordsImpl extends ASTWrapperPsiElement implements TeoConfigKeywords {

  public TeoConfigKeywordsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitConfigKeywords(this);
  }
