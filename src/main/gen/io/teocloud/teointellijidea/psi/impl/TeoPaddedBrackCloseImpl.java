...
public class TeoPaddedBrackCloseImpl extends ASTWrapperPsiElement implements TeoPaddedBrackClose {

  public TeoPaddedBrackCloseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitPaddedBrackClose(this);
  }
