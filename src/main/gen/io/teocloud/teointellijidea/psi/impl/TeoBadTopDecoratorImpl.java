...
public class TeoBadTopDecoratorImpl extends ASTWrapperPsiElement implements TeoBadTopDecorator {

  public TeoBadTopDecoratorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeoVisitor visitor) {
    visitor.visitBadTopDecorator(this);
  }
